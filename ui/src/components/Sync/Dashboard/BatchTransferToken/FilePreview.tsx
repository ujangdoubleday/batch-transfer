...
import { cn } from '../../../../lib/utils'; // Adjust based on actual path or use @ alias if available.
// Relative path from src/components/Sync/Dashboard/BatchTransferToken/FilePreview.tsx
// to src/lib/utils is ../../../../lib/utils
...
export function FilePreview({ recipients, amounts, decimals, maxRecipients, fileName, tokenSymbol, onClear }: Props) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-white/5">
        ...
        <div className="p-4 bg-black/20 rounded-lg">
            ...
            <p className="text-2xl font-bold text-white truncate" title={formatUnits(totalAmount, Number(decimals))}>
                ...
                <span className="text-sm font-normal text-zinc-500 ml-1">{tokenSymbol || 'Tokens'}</span>
            </p>
        </div>
        <div className={cn(
