  ...
  return (
    <WalletConnectGuard>
      <div className="flex flex-col items-center justify-start min-h-[calc(100vh-100px)] px-4 md:px-8 pb-8 bg-[radial-gradient(circle_at_50%_0%,rgba(255,255,255,0.03)_0%,transparent_70%)]">
        <div className={cn(
            "w-full mt-4 md:mt-0 transition-all duration-300 animate-in fade-in slide-in-from-bottom-5",
            "max-w-[1200px] grid grid-cols-1 lg:grid-cols-2 gap-8 items-start"
        )}>
          <div className="text-center mb-4 lg:mb-8 col-span-full">
            <h2 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-br from-white to-zinc-400 bg-clip-text text-transparent tracking-tight">
              Batch Sync
            </h2>
          ...
          <div className="w-full order-2 lg:order-1">
             ...
             {deployments.length === 0 && (
                 <div className="text-center p-6 md:p-8 border border-white/10 rounded-xl bg-white/5 backdrop-blur-sm mt-4 lg:mt-0">
          ...
          <div className="w-full order-1 lg:order-2">
             <h3 className="text-lg font-semibold mb-4 text-zinc-400 text-center lg:text-left">Import Contract</h3>
             <div className="w-full bg-transparent border border-zinc-700/50 rounded-xl p-4 md:p-6">
                <ImportAddressForm />
             </div>
          </div>
        </div>
